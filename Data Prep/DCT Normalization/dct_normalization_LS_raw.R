...
write.csv(df_with_dct, "dct_LS_raw.csv")
write.csv(df_final, "dct_spread_LS_raw.csv")
...
write.csv(dct_s1_s2, "dct_LS_raw_s1_s2.csv")
...
write.csv(dct_cont, "dct_LS_raw_cont.csv")
write.csv(dct_spread_cont, "dct_spread_LS_raw_cont.csv")
