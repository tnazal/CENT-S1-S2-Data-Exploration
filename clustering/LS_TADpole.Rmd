...
# diagnostics
diagnostics_LS_raw_tadpole_s1_5cl <- cluster.stats(tadpole_s1_5cl_d, as.numeric(tadpole_clust5_s1_df$cluster))
diagnostics_LS_raw_tadpole_s1_3cl <- cluster.stats(tadpole_s1_3cl_d, as.numeric(tadpole_clust3_s1_df$cluster))
diagnostics_LS_raw_tadpole_s2_4cl <- cluster.stats(tadpole_s2_4cl_d, as.numeric(tadpole_clust4_s2_df$cluster))
diagnostics_LS_raw_tadpole_s2_3cl <- cluster.stats(tadpole_s2_3cl_d, as.numeric(tadpole_clust3_s2_df$cluster))
diagnostics_LS_raw_tadpole_cont_5cl <- cluster.stats(tadpole_cont_5cl_d, as.numeric(tadpole_clust5_cont_df$cluster))
diagnostics_LS_raw_tadpole_cont_3cl <- cluster.stats(tadpole_cont_3cl_d, as.numeric(tadpole_clust3_cont_df$cluster))
diagnostics_LS_raw_tadpole_sep_5cl <- cluster.stats(tadpole_sep_5cl_d, as.numeric(tadpole_clust5_s1_s2_df$cluster))
diagnostics_LS_raw_tadpole_sep_3cl <- cluster.stats(tadpole_sep_3cl_d, as.numeric(tadpole_clust3_s1_s2_df$cluster))
...
```{r}
# write table
write.csv(diagnostic_df, "diagnostics_LS_raw_tadpole.csv")
```