...
# diagnostics
diagnostics_LS_raw_kmeans_s1_3cl <- cluster.stats(kmeans_s1_3cl_d, as.numeric(clusters3_s1_spread$cluster_kmeans_3))
diagnostics_LS_raw_kmeans_s1_4cl <- cluster.stats(kmeans_s1_4cl_d, as.numeric(clusters4_s1_spread$cluster_kmeans_4))
diagnostics_LS_raw_kmeans_s1_5cl <- cluster.stats(kmeans_s1_5cl_d, as.numeric(clusters5_s1_spread$cluster_kmeans_5))
diagnostics_LS_raw_kmeans_s2_3cl <- cluster.stats(kmeans_s2_3cl_d, as.numeric(clusters3_s2_spread$cluster_kmeans_3))
diagnostics_LS_raw_kmeans_s2_4cl <- cluster.stats(kmeans_s2_4cl_d, as.numeric(clusters4_s2_spread$cluster_kmeans_4))
diagnostics_LS_raw_kmeans_s2_5cl <- cluster.stats(kmeans_s2_5cl_d, as.numeric(clusters5_s2_spread$cluster_kmeans_5))
diagnostics_LS_raw_kmeans_sep_3cl <- cluster.stats(kmeans_s1_s2_3cl_d, as.numeric(clusters3_s1_s2_spread$cluster_kmeans_3))
diagnostics_LS_raw_kmeans_sep_4cl <- cluster.stats(kmeans_s1_s2_4cl_d, as.numeric(clusters4_s1_s2_spread$cluster_kmeans_4))
diagnostics_LS_raw_kmeans_sep_5cl <- cluster.stats(kmeans_s1_s2_5cl_d, as.numeric(clusters5_s1_s2_spread$cluster_kmeans_5))
diagnostics_LS_raw_kmeans_cont_3cl <- cluster.stats(kmeans_cont_3cl_d, as.numeric(clusters3_cont_spread$cluster_kmeans_3))
diagnostics_LS_raw_kmeans_cont_5cl <- cluster.stats(kmeans_cont_5cl_d, as.numeric(clusters5_cont_spread$cluster_kmeans_5))
...
```{r}
# write table
write.csv(diagnostic_df, "diagnostics_LS_raw_kmeans.csv")
```
