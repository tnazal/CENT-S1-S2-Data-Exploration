...
# diagnostics
diagnostics_LS_growth_kshape_s1_5cl <- cluster.stats(s1_5clusters_d, as.numeric(clusters_s1_shape5_spread$cluster_shape_5))
diagnostics_LS_growth_kshape_s2_2cl <- cluster.stats(s2_2clusters_d, as.numeric(clusters_s2_shape2_spread$cluster_shape_2))
diagnostics_LS_growth_kshape_cont_5cl <- cluster.stats(cont_5clusters_d, as.numeric(clusters_cont_shape5_spread$cluster_shape_5))
diagnostics_LS_growth_kshape_sep_5cl <- cluster.stats(s1_s2_5clusters_d, as.numeric(clusters_s1_s2_shape5_spread$cluster_shape_5))
diagnostics_LS_growth_dtw_s1_3cl <- cluster.stats(s1_3clusters_d, as.numeric(clusters_s1_dtw3_spread$cluster_dtw_3))
diagnostics_LS_growth_dtw_s2_2cl <- cluster.stats(s2_2clusters_d, as.numeric(clusters_s2_dtw2_spread$cluster_dtw_2))
diagnostics_LS_growth_dtw_cont_4cl <- cluster.stats(cont_4clustdtw_d, as.numeric(clusters_cont_dtw4_spread$cluster_dtw_4))
diagnostics_LS_growth_dtw_sep_3cl <- cluster.stats(s1_s2_3clusters_d, as.numeric(clusters_s1_s2_dtw3_spread$cluster_dtw_3))
