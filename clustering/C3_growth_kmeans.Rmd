...
clusters5_s1 <- clusters5_s1 %>% 
  filter(Season_num == 1)
```

```{r}
s1_growth_5kmeans <- plot_ly(clusters5_s1, 
        x = ~period, 
        y = ~dct_values, 
        color = ~Show_Name,
  ...
  layout(showlegend = TRUE, 
         title = "Season 1 with 5 K-Means Clusters (C3 Growth)", 
...
```{r}
# htmlwidgets::saveWidget(s1_growth_5kmeans, "s1_growth_5kmeans.html", selfcontained = TRUE)
```
