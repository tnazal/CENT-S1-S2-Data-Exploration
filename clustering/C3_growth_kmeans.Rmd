...
write.csv(clusters4_s1, "C3_growth_s1_4kmeans_clusters.csv")
```
...
write.csv(dct_s1_4clusters_s2_trends, "C3_growth_s1_4kmeans_s2trends.csv")
```
...
write.csv(clusters5_s1, "C3_growth_s1_5kmeans_clusters.csv")
```
...
write.csv(dct_s1_5clusters_s2_trends, "C3_growth_s1_5kmeans_s2trends.csv")
```
...
```{r}
# htmlwidgets::saveWidget(s1_growth_5kmeans_s2trends, "s1_growth_5kmeans_s2trends.html", selfcontained = TRUE)
```
...
```{r}
# htmlwidgets::saveWidget(s2_growth_5kmeans, "s2_growth_5kmeans.html", selfcontained = TRUE)
```
...
```{r}
# htmlwidgets::saveWidget(s1_s2_growth_5kmeans, "s1_s2_growth_5kmeans.html", selfcontained = TRUE)
```
...
```{r}
# htmlwidgets::saveWidget(cont_growth_5kmeans, "cont_growth_5kmeans.html", selfcontained = TRUE)
```
...
write.csv(s1_clusters_cont_trends, "C3_growth_s1_4kmeans_cont_trends.csv") 
```
...
write.csv(s1_clusters_cont_trends, "C3_growth_s1_5kmeans_cont_trends.csv") 
```
...
diagnostics_C3_growth_kmeans_cont_3cl <- cluster.stats(kmeans_cont_3cl_growth_d, as.numeric(clusters3_cont_spread$cluster_kmeans_3))
