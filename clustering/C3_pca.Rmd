...
```{r}
##################################################################################
# inputs: CENT_dct_spread.csv, CENT_dct_spread_cont.csv, CENT_dct.csv"
#
...
# diagnostics
diagnostics_C3_raw_pca_s1_3cl <- cluster.stats(pca_s1_3cl_d, as.numeric(df_pcaclusters_s1$cluster))
diagnostics_C3_raw_pca_s2_3cl <- cluster.stats(pca_s2_3cl_d, as.numeric(df_pcaclusters_s2$cluster))
diagnostics_C3_raw_pca_cont_3cl <- cluster.stats(pca_cont_3cl_d, as.numeric(df_pcaclusters_cont$cluster))
diagnostics_C3_raw_pca_sep_4cl <- cluster.stats(pca_sep_4cl_d, as.numeric(df_pcaclusters_s1_s2$cluster))
...
```{r}
# write table
write.csv(diagnostic_df, "diagnostics_C3_raw_pca.csv")
```
