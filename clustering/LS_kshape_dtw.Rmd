...
clusters_cont_dtw3 <- merge(clusters_cont_dtw3_spread[, c("cluster_dtw_3", "Show_Name")], 
                            dct_cont, by = "Show_Name")

season1_dtw3_clusters <- clusters_cont_dtw3_spread %>% 
  select(Show_Name, cluster_dtw_3) %>% 
  rename(s1_cluster = cluster_dtw_3)

s1_clusters_cont_trends <- merge(season1_dtw3_clusters, 
...
write.csv(s1_clusters_cont_trends, "LS_raw_s1_3dtw_cont_trends.csv") 
```

```{r}
# Plot for S1-S2 Trends Clustered on S1 3 DTW Clusters
