...
```{r}
##################################################################################
# inputs: CENT_LS_dct.csv, CENT_LS_dct_cont.csv, CENT_LS_dct_s1_s2.csv,
#         CENT_LS_dct_spread.csv, CENT_LS_dct_spread_cont.csv 
#
...
dct_s1_s2 <- read.csv("CENT_LS_dct_s1_s2.csv")
```
...
# diagnostics
diagnostics_LS_raw_kshape_s1_2cl <- cluster.stats(s1_2clusters_d, as.numeric(clusters_s1_shape2_spread$cluster_shape_2))
diagnostics_LS_raw_kshape_s2_5cl <- cluster.stats(s2_5clusters_d, as.numeric(clusters_s2_shape5_spread$cluster_shape_5))
diagnostics_LS_raw_kshape_cont_4cl <- cluster.stats(cont_4clusters_d, as.numeric(clusters_cont_shape4_spread$cluster_shape_4))
diagnostics_LS_raw_kshape_sep_5cl <- cluster.stats(s1_s2_5clusters_d, as.numeric(clusters_s1_s2_shape5_spread$cluster_shape_5))
diagnostics_LS_raw_dtw_s1_3cl <- cluster.stats(s1_3clusters_d, as.numeric(clusters_s1_dtw3_spread$cluster_dtw_3))
diagnostics_LS_raw_dtw_s2_3cl <- cluster.stats(s2_3clusters_d, as.numeric(clusters_s2_dtw3_spread$cluster_dtw_3))
diagnostics_LS_raw_dtw_cont_2cl <- cluster.stats(cont_2clustdtw_d, as.numeric(clusters_cont_dtw2_spread$cluster_dtw_2))
diagnostics_LS_raw_dtw_sep_4cl <- cluster.stats(s1_s2_4clusters_d, as.numeric(clusters_s1_s2_dtw4_spread$cluster_dtw_4))
...
```{r}
# write table
write.csv(diagnostic_df, "diagnostics_LS_raw_kshape_dtw.csv")
```
