---
title: "CENT S1-S2 K-Means Clustering on C3 Impressions"
output:
...
ggplotly(clusters3_s1_plot) %>% 
  layout(title = "Season 1 with 3 K-Means Clusters (C3)", 
         margin = list(t = 150))
```
...
ggplotly(s1_3clusters_s2_trends_plot) %>% 
  layout(title = "Season 1 with 3 K-Means Clusters & Season 2 Trends (C3)", 
         margin = list(t = 150))
```
...
ggplotly(clusters4_s1_plot) %>% 
  layout(title = "Season 1 with 4 K-Means Clusters (C3)", 
         margin = list(t = 150))
```
...
ggplotly(s1_4clusters_s2_trends_plot) %>% 
  layout(title = "Season 1 with 4 K-Means Clusters & Season 2 Trends (C3)", 
         margin = list(t = 150))
```
...
write.csv(clusters5_s1, "C3_raw_s1_5kmeans_clusters.csv")
```
...
ggplotly(clusters5_s1_plot) %>% 
  layout(title = "Season 1 with 5 K-Means Clusters (C3)", 
         margin = list(t = 150))
```
...
write.csv(dct_s1_5clusters_s2_trends, "C3_raw_s1_5kmeans_s2trends.csv")
```
...
s1_5kmeans_s2trends <- ggplotly(s1_5clusters_s2_trends_plot) %>% 
  layout(title = "Season 1 with 5 K-Means Clusters & Season 2 Trends (C3)", 
...
```{r}
# htmlwidgets::saveWidget(s1_5kmeans_s2trends, "s1_5kmeans_s2trends.html", selfcontained = TRUE)
```

```{r}
# TEST PLOT WITH GROUPINGS BY NETWORK
by_network_5kmeans<- plot_ly(dct_s1_5clusters_s2_trends, 
        x = ~period, 
        y = ~dct_values, 
        color = ~Show_Name,
  ...
  layout(showlegend = TRUE, 
         title = "Season 1 with 5 K-Means Clusters & Season 2 Trends (C3)", 
         autosize = FALSE, width = 650, height = 800, 
         margin = list(l = 50, 
                       r = 50, 
                       b = 50, 
...
```{r}
# htmlwidgets::saveWidget(by_network_5kmeans, "by_network_5kmeans.html", selfcontained = TRUE)
```

```{r}
# TEST PLOT WITH GROUPINGS BY CLUSTER
by_cluster_5kmeans <- plot_ly(dct_s1_5clusters_s2_trends, 
        x = ~period, 
        y = ~dct_values, 
        color = ~Show_Name,
        yaxis = ~paste0('y', cluster_kmeans_5), 
...
```{r}
# htmlwidgets::saveWidget(by_cluster_5kmeans, "by_cluster_5kmeans.html", selfcontained = TRUE)
```

```{r}
# TEST PLOT WITH GROUPINGS BY SHOW NAME
by_showname_5kmeans <- plot_ly(dct_s1_5clusters_s2_trends, 
        x = ~period, 
        y = ~dct_values, 
        color = ~Show_Name,
        yaxis = ~paste0('y', cluster_kmeans_5), 
...
```{r}
# htmlwidgets::saveWidget(by_showname_5kmeans, "s1_5kmeans_s2trends.html", selfcontained = TRUE)
# htmlwidgets::saveWidget(by_showname_5kmeans, "by_showname_5kmeans.html", selfcontained = TRUE)
```
...
ggplotly(clusters3_s2_plot) %>% 
  layout(title = "Season 2 with 3 K-Means Clusters (C3)", 
         margin = list(t = 150))
```
...
ggplotly(clusters4_s2_plot) %>% 
  layout(title = "Season 2 with 4 K-Means Clusters (C3)", 
         margin = list(t = 150))
```
...
s2_5kmeans <- ggplotly(clusters5_s2_plot) %>% 
  layout(showlegend = TRUE, 
         title = "Season 2 with 5 K-Means Clusters (C3)", 
...
```{r}
# htmlwidgets::saveWidget(s2_5kmeans, "s2_5kmeans.html", selfcontained = TRUE) 
```
...
ggplotly(clusters3_s1_s2_plot) %>% 
  layout(title = "S1-S2 (Non-Continuous) with 3 K-Means Clusters (C3)", 
         margin = list(t = 150))
```
...
s1_s2_5kmeans <- ggplotly(clusters5_s1_s2_plot) %>% 
  layout(showlegend = TRUE, 
         title = "S1 & S2 with 5 K-Means Clusters (C3)", 
         autosize = FALSE, width = 550, height = 800, 
         margin = list(l = 50, 
                       r = 50, 
                       b = 50, 
...
```{r}
# htmlwidgets::saveWidget(s1_s2_5kmeans, "s1_s2_5kmeans.html", selfcontained = TRUE)
```
...
ggplotly(clusters3_cont_plot) %>% 
  layout(title = "S1-S2 (Continuous) with 3 K-Means Clusters (C3)", 
         margin = list(t = 150))
```
...
cont_5kmeans <- ggplotly(clusters5_cont_plot) %>% 
  layout(showlegend = TRUE, 
         title = "S1-S2 with 5 K-Means Clusters (C3)", 
         autosize = FALSE, width = 550, height = 800, 
         margin = list(l = 50, 
...
```{r}
# htmlwidgets::saveWidget(cont_5kmeans, "cont_5kmeans.html", selfcontained = TRUE)
```
...
write.csv(s1_clusters_cont_trends, "C3_raw_s1_5kmeans_cont_trends.csv") 
```
...
s1_clusters_cont_trends_plot <- plot_ly(s1_clusters_cont_trends, 
  ...
  subplot(nrows = 5, shareX = TRUE) %>% 
  layout(showlegend = TRUE, 
         title = "S1-S2 Clustered on S1 Clusters (C3)", 
         autosize = FALSE, width = 650, height = 800, 
         margin = list(l = 50, 
                       r = 50, 
                       b = 50, 
...
```{r}
# htmlwidgets::saveWidget(s1_clusters_cont_trends_plot, "cont_s1clusters.html", selfcontained = TRUE)
```
...
s1_4clusters_cont_trends <- merge(season1_kmeans4_clusters, 
                                  dct_spread_cont, by = "Show_Name") %>% 
  select(-X)

s1_4clusters_cont_trends <- merge(s1_4clusters_cont_trends[, c("Show_Name", "s1_cluster")], 
                                  dct_cont, by = "Show_Name") %>% 
  select(-X)
```
...
```{r}
# Plot for Continuous Trends Clustered on S1 Clusters
s1_4clusters_cont_trends_plot <- plot_ly(s1_4clusters_cont_trends, 
        x = ~period, 
        y = ~dct_values, 
        color = ~Show_Name,
        yaxis = ~paste0('y', s1_cluster), 
...
s1_4clusters_cont_trends_plot
```

```{r}
# htmlwidgets::saveWidget(s1_4clusters_cont_trends_plot, "cont_s1clusters_4kmeans.html", selfcontained = TRUE)
```
...
# diagnostics
diagnostics_C3_raw_kmeans_s1_3cl <- cluster.stats(kmeans_s1_3cl_d, as.numeric(clusters3_s1_spread$cluster_kmeans_3))
diagnostics_C3_raw_kmeans_s1_4cl <- cluster.stats(kmeans_s1_4cl_d, as.numeric(clusters4_s1_spread$cluster_kmeans_4))
diagnostics_C3_raw_kmeans_s1_5cl <- cluster.stats(kmeans_s1_5cl_d, as.numeric(clusters5_s1_spread$cluster_kmeans_5))
diagnostics_C3_raw_kmeans_s2_3cl <- cluster.stats(kmeans_s2_3cl_d, as.numeric(clusters3_s2_spread$cluster_kmeans_3))
diagnostics_C3_raw_kmeans_s2_4cl <- cluster.stats(kmeans_s2_4cl_d, as.numeric(clusters4_s2_spread$cluster_kmeans_4))
diagnostics_C3_raw_kmeans_s2_5cl <- cluster.stats(kmeans_s2_5cl_d, as.numeric(clusters5_s2_spread$cluster_kmeans_5))
diagnostics_C3_raw_kmeans_sep_3cl <- cluster.stats(kmeans_s1_s2_3cl_d, as.numeric(clusters3_s1_s2_spread$cluster_kmeans_3))
diagnostics_C3_raw_kmeans_sep_5cl <- cluster.stats(kmeans_s1_s2_5cl_d, as.numeric(clusters5_s1_s2_spread$cluster_kmeans_5))
diagnostics_C3_raw_kmeans_cont_3cl <- cluster.stats(kmeans_cont_3cl_d, as.numeric(clusters3_cont_spread$cluster_kmeans_3))
diagnostics_C3_raw_kmeans_cont_5cl <- cluster.stats(kmeans_cont_5cl_d, as.numeric(clusters5_cont_spread$cluster_kmeans_5))
...
```{r}
# write table
write.csv(diagnostic_df, "diagnostics_C3_raw_kmeans.csv")
```
