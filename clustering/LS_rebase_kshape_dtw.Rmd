---
title: "CENT S1-S2 K-Shape and DTW Clustering on LS Rebase"
output:
...
```{r}
##################################################################################
# inputs: CENT_LS_rebase_dct.csv, CENT_LS_rebase_dct_spread.csv,
#        CENT_LS_rebase_dct_spread_cont.csv, CENT_LS_rebase_dct_cont.csv, 
#        CENT_LS_rebase_dct_s1_s2.csv
#
...
ggplotly(clusters_s1_shape2_plot) %>% 
  layout(title = "Season 1 with 2 K-Shape Clusters (LS Rebase)", 
         margin = list(t = 150))
```
...
s1_2clusters_kshape_s2_trends_plot <- dct_s1_2clusters_kshape_s2_trends %>%
  ggplot(aes(x = period, y = dct_values, color = Show_Name)) + 
  geom_line() + 
  facet_wrap(~ cluster_shape_2, nrow = 4) + 
  theme(axis.title.x = element_blank(), 
        axis.title.y = element_blank())

ggplotly(s1_2clusters_kshape_s2_trends_plot) %>% 
  layout(title = "Season 1 with 2 K-Shape Clusters & Season 2 Trends (LS Rebase)", 
         margin = list(t = 150))
```
...
ggplotly(clusters_s1_dtw3_plot) %>% 
  layout(title = "Season 1 with 3 DTW Clusters (LS Rebase)", 
         margin = list(t = 150))
```
...
ggplotly(s1_3clusters_dtw_s2_trends_plot) %>% 
  layout(title = "Season 1 with 3 DTW Clusters & Season 2 Trends (LS Rebase)", 
         margin = list(t = 150))
```
...
ggplotly(clusters_s2_shape5_plot) %>% 
  layout(title = "Season 2 with 5 K-Shape Clusters (LS Rebase)", 
         margin = list(t = 150))
```
...
ggplotly(clusters_s2_dtw3_plot) %>% 
  layout(title = "Season 2 with 3 DTW Clusters (LS Rebase)", 
         margin = list(t = 150))
```
...
```{r}
dct_cont <- read.csv("CENT_LS_rebase_dct_cont.csv")
...
ggplotly(clusters_cont_shape4_plot) %>% 
  layout(title = "S1-S2 (Continuous) with 4 K-Shape Clusters (LS Rebase)", 
         margin = list(t = 150))
```
...
ggplotly(clusters_cont_dtw2_plot) %>% 
  layout(title = "S1-S2 (Continuous) with 2 DTW Clusters (LS Rebase)", 
         margin = list(t = 150))
```
...
dct_s1_s2 <- read.csv("CENT_LS_rebase_dct_s1_s2.csv")
```
...
ggplotly(clusters_s1_s2_shape5_plot) %>% 
  layout(title = "S1-S2 (Non-Continuous) with 5 K-Shape Clusters (LS Rebase)", 
         margin = list(t = 150))
```
...
ggplotly(clusters_s1_s2_dtw4_plot) %>% 
  layout(title = "S1-S2 (Non-Continuous) with 4 DTW Clusters (LS Rebase)", 
         margin = list(t = 150))
```
...
# diagnostics
diagnostics_LS_rebase_kshape_s1_2cl <- cluster.stats(s1_2clusters_d, as.numeric(clusters_s1_shape2_spread$cluster_shape_2))
diagnostics_LS_rebase_kshape_s2_5cl <- cluster.stats(s2_5clusters_d, as.numeric(clusters_s2_shape5_spread$cluster_shape_5))
diagnostics_LS_rebase_kshape_cont_4cl <- cluster.stats(cont_4clusters_d, as.numeric(clusters_cont_shape4_spread$cluster_shape_4))
diagnostics_LS_rebase_kshape_sep_5cl <- cluster.stats(s1_s2_5clusters_d, as.numeric(clusters_s1_s2_shape5_spread$cluster_shape_5))
diagnostics_LS_rebase_dtw_s1_3cl <- cluster.stats(s1_3clusters_d, as.numeric(clusters_s1_dtw3_spread$cluster_dtw_3))
diagnostics_LS_rebase_dtw_s2_3cl <- cluster.stats(s2_3clusters_d, as.numeric(clusters_s2_dtw3_spread$cluster_dtw_3))
diagnostics_LS_rebase_dtw_cont_2cl <- cluster.stats(cont_2clustdtw_d, as.numeric(clusters_cont_dtw2_spread$cluster_dtw_2))
diagnostics_LS_rebase_dtw_sep_4cl <- cluster.stats(s1_s2_4clusters_d, as.numeric(clusters_s1_s2_dtw4_spread$cluster_dtw_4))
...
```{r}
# write table
write.csv(diagnostic_df, "diagnostics_LS_rebase_kshape_dtw.csv")
```