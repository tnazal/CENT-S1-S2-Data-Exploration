---
title: "CENT S1-S2 TADpole Clustering on LS Rebase"
output:
...
```{r}
##################################################################################
# inputs:  CENT_LS_rebase_dct_spread.csv, CENT_LS_rebase_dct_cont.csv,
#          CENT_LS_rebase_dct_spread_cont.csv, CENT_LS_rebase_dct.csv
#
...
ggplotly(tadpole5_s1_plot) %>% 
  layout(title = "Season 1 with 5 TADpole Clusters (LS Rebase)", 
         margin = list(t = 150))
```
...
ggplotly(s1_5clusters_tadpole_s2_trends_plot) %>% 
  layout(title = "Season 1 with 5 TADpole Clusters & Season 2 Trends (LS Rebase)", 
         margin = list(t = 150))
```
...
ggplotly(tadpole3_s1_plot) %>% 
  layout(title = "Season 1 with 3 TADpole Clusters (LS Rebase)", 
         margin = list(t = 150))
```
...
ggplotly(s1_3clusters_tadpole_s2_trends_plot) %>% 
  layout(title = "Season 1 with 3 TADpole Clusters & Season 2 Trends (LS Rebase)", 
         margin = list(t = 150))
```
...
```{r}
set.seed(12)
tadpole_clust4_s2 <- TADPole(dtw_df_s2, k = 4L, window.size = 5, dc = 15)
...
ggplotly(tadpole4_s2_plot) %>% 
  layout(title = "Season 2 with 4 TADpole Clusters (LS Rebase)", 
         margin = list(t = 150))
```
...
```{r}
set.seed(12)
tadpole_clust3_s2 <- TADPole(dtw_df_s2, k = 3L, window.size = 5, dc = 15)
...
ggplotly(tadpole3_s2_plot) %>% 
  layout(title = "Season 2 with 3 TADpole Clusters (LS Rebase)", 
         margin = list(t = 150))
```
...
```{r}
set.seed(12)
tadpole_clust5_cont <- TADPole(dtw_df_cont, k = 5L, window.size = 5, dc = 15)
...
ggplotly(tadpole5_cont_plot) %>% 
  layout(title = "S1-S2 (Continuous) with 5 TADpole Clusters (LS Rebase)", 
         margin = list(t = 150))
```
...
```{r}
set.seed(12)
tadpole_clust3_cont <- TADPole(dtw_df_cont, k = 3L, window.size = 5, dc = 15)
...
ggplotly(tadpole3_cont_plot) %>% 
  layout(title = "S1-S2 (Continuous) with 3 TADpole Clusters (LS Rebase)", 
         margin = list(t = 150))
```
...
ggplotly(tadpole5_s1_s2_plot) %>% 
  layout(title = "S1-S2 (Non-Continuous) with 5 TADpole Clusters (LS Rebase)", 
         margin = list(t = 150))
```
...
ggplotly(tadpole3_s1_s2_plot) %>% 
  layout(title = "S1-S2 (Non-Continuous) with 3 TADpole Clusters (LS Rebase)", 
         margin = list(t = 150))
```
...
# diagnostics
diagnostics_LS_rebase_tadpole_s1_5cl <- cluster.stats(tadpole_s1_5cl_d, as.numeric(tadpole_clust5_s1_df$cluster))
diagnostics_LS_rebase_tadpole_s1_3cl <- cluster.stats(tadpole_s1_3cl_d, as.numeric(tadpole_clust3_s1_df$cluster))
diagnostics_LS_rebase_tadpole_s2_4cl <- cluster.stats(tadpole_s2_4cl_d, as.numeric(tadpole_clust4_s2_df$cluster))
diagnostics_LS_rebase_tadpole_s2_3cl <- cluster.stats(tadpole_s2_3cl_d, as.numeric(tadpole_clust3_s2_df$cluster))
diagnostics_LS_rebase_tadpole_cont_5cl <- cluster.stats(tadpole_cont_5cl_d, as.numeric(tadpole_clust5_cont_df$cluster))
diagnostics_LS_rebase_tadpole_cont_3cl <- cluster.stats(tadpole_cont_3cl_d, as.numeric(tadpole_clust3_cont_df$cluster))
diagnostics_LS_rebase_tadpole_sep_5cl <- cluster.stats(tadpole_sep_5cl_d, as.numeric(tadpole_clust5_s1_s2_df$cluster))
diagnostics_LS_rebase_tadpole_sep_3cl <- cluster.stats(tadpole_sep_3cl_d, as.numeric(tadpole_clust3_s1_s2_df$cluster))
...
```{r}
# write table
write.csv(diagnostic_df, "diagnostics_LS_rebase_tadpole.csv")
```