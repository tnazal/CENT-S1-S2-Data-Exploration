---
title: "Exploratory Plots for Normalized LS Impressions"
output:
...
```{r}
##################################################################################
# inputs: CENT_LS_dct.csv, CENT_LS_growth_dct.csv, CENT_LS_rebase_dct.csv
#
# purpose: Exploratory plots for raw, growth, and 1st episode rebase trends,
#          normalized LS impressions
##################################################################################
```
...
# Raw LS Impressions, Normalized

Read data
```{r}
df_with_dct <- read.csv("CENT_LS_dct.csv")
...
DCT_trends <- ggplotly(ggplot(df %>% filter(Season_num < 3)) + 
  ...
  layout(title = "DCT Value Trends for All Shows and Networks (LS)", 
...
```{r}
#htmlwidgets::saveWidget(DCT_trends, "DCT_trends_LS.html", selfcontained = TRUE)
```
...
DCT_linear <- ggplotly(ggplot(df %>% filter (Season_num < 3)) + 
                         ...
                         facet_wrap(~Season_num, nrow = 2) + my_theme) %>% 
  layout(title = "DCT Linear Trends for All Shows and Networks (LS)", 
         autosize = FALSE, width = 650, height = 800, 
         margin = list(l = 50, 
                       r = 50, 
                       b = 50, 
...
```{r}
#htmlwidgets::saveWidget(DCT_linear, "DCT_linear_LS.html", selfcontained = TRUE)
```
...
Read data
```{r}
df_growth <- read.csv("CENT_LS_growth_dct.csv")
```
...
DCT_growth_trends <- ggplotly(ggplot(df_growth %>% filter(Season_num < 3)) + 
                                ...
                                geom_line(data = df_growth %>% 
                                          ...
                                          color = "black", linetype = "dashed",size = 1.3) + 
                                facet_wrap(~Season_num, nrow = 2) + my_theme) %>% 
  layout(title = "DCT Growth Trends for All Shows and Networks (LS)", 
         autosize = FALSE, width = 650, height = 800, 
         margin = list(l = 50, 
                       r = 50, 
                       b = 50, 
...
```{r}
#htmlwidgets::saveWidget(DCT_growth_trends, "DCT_growth_trends_LS.html", selfcontained = TRUE) 
```
...
DCT_growth_linear <- ggplotly(ggplot(df_growth  %>% filter (Season_num < 3)) + 
                                ...
                                facet_wrap(~Season_num, nrow = 2) + my_theme) %>% 
  layout(title = "DCT Growth Linear Trends for All Shows and Networks (LS)", 
         autosize = FALSE, width = 650, height = 800,
         margin = list(l = 50, 
                       r = 50, 
                       b = 50, 
...
```{r}
#htmlwidgets::saveWidget(DCT_growth_linear, "DCT_growth_linear_LS.html", selfcontained = TRUE)
```
...
Read data
```{r}
df_rebase <- read.csv("CENT_LS_rebase_dct.csv")
```
...
DCT_rebase_trends <- ggplotly(ggplot(df_rebase %>% filter(Season_num < 3)) + 
                                ...
                                geom_line(data = df_rebase %>% 
                                          ...
                                          color = "black", linetype = "dashed", size = 1.3) + 
                                facet_wrap(~Season_num, nrow = 2) + my_theme) %>% 
  layout(title = "DCT Rebase Trends for All Shows and Networks (LS)", 
         autosize = FALSE, width = 650, height = 800, 
         margin = list(l = 50, 
                       r = 50, 
                       b = 50, 
...
```{r}
#htmlwidgets::saveWidget(DCT_rebase_trends, "DCT_rebase_trends_LS.html", selfcontained = TRUE)
```
...
DCT_rebase_linear <- ggplotly(ggplot(df_rebase %>% filter(Season_num < 3)) + 
                                ...
                                stat_smooth(aes(x = period, y = dct_values), 
                                            ...
                                            color = "black", linetype = "dashed", size = 1.4) + 
                                facet_wrap(~Season_num, nrow = 2) + my_theme) %>% 
  layout(title = "DCT Rebase Linear Trends for All Shows and Networks (LS)", 
         autosize = FALSE, width = 650, height = 800, 
         margin = list(l = 50, 
                       r = 50, 
                       b = 50, 
...
```{r}
#htmlwidgets::saveWidget(DCT_rebase_linear, "DCT_rebase_linear_LS.html", selfcontained = TRUE) 
```
