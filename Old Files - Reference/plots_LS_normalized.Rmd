---
title: "Exploratory Plots for Normalized LS"
output:
...
```{r}
##################################################################################
# inputs: dct_LS_raw.csv, dct_LS_growth.csv
#
# purpose: Exploratory plots for raw and growth normalized LS impressions
##################################################################################
```
...
Read data
```{r}
df_with_dct <- read.csv("dct_LS_raw.csv")
...
Read data
```{r}
df_growth <- read.csv("dct_LS_growth.csv")
```
