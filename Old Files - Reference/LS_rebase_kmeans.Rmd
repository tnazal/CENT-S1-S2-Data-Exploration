---
title: "CENT S1-S2 K-Means Clustering on LS Rebase"
output:
...
ggplotly(clusters3_s1_plot) %>% 
  layout(title = "Season 1 with 3 K-Means Clusters (LS Rebase)", 
         margin = list(t = 150))
```
...
ggplotly(s1_3clusters_s2_trends_plot) %>% 
  layout(title = "Season 1 with 3 K-Means Clusters & Season 2 Trends (LS Rebase)", 
         margin = list(t = 150))
```
...
ggplotly(clusters5_s1_plot) %>% 
  layout(title = "Season 1 with 5 K-Means Clusters (LS Rebase)", 
         margin = list(t = 150))
```
...
ggplotly(s1_5clusters_s2_trends_plot) %>% 
  layout(title = "Season 1 with 5 K-Means Clusters & Season 2 Trends (LS Rebase)", 
         margin = list(t = 150))
```
...
ggplotly(clusters4_s2_plot) %>% 
  layout(title = "Season 2 with 4 K-Means Clusters (LS Rebase)", 
         margin = list(t = 150))
```
...
ggplotly(clusters5_s2_plot) %>% 
  layout(title = "Season 2 with 5 K-Means Clusters (LS Rebase)", 
         margin = list(t = 150))
```
...
ggplotly(clusters3_s1_s2_plot) %>% 
  layout(title = "S1-S2 (Non-Continuous) with 3 K-Means Clusters (LS Rebase)", 
         margin = list(t = 150))
```
...
ggplotly(clusters5_s1_s2_plot) %>% 
  layout(title = "S1-S2 (Non-Continuous) with 5 K-Means Clusters (LS Rebase)", 
         margin = list(t = 150))
```
...
ggplotly(clusters2_cont_plot) %>% 
  layout(title = "S1-S2 (Continuous) with 2 K-Means Clusters (LS Rebase)", 
         margin = list(t = 150))
```
...
ggplotly(clusters3_cont_plot) %>% 
  layout(title = "S1-S2 (Continuous) with 3 K-Means Clusters (LS Rebase)", 
         margin = list(t = 150))
```
...
ggplotly(clusters5_cont_plot) %>% 
  layout(title = "S1-S2 (Continuous) with 5 K-Means Clusters (LS Rebase)", 
         margin = list(t = 150))
```
...
kmeans_cont_2cl_d <- dist(clusters2_cont_spread[, 5:104])
kmeans_cont_3cl_d <- dist(clusters3_cont_spread[, 5:104])
kmeans_cont_5cl_d <- dist(clusters5_cont_spread[, 5:104])

# diagnostics
diagnostics_LS_rebase_kmeans_s1_3cl <- cluster.stats(kmeans_s1_3cl_d, as.numeric(clusters3_s1_spread$cluster_kmeans_3))
diagnostics_LS_rebase_kmeans_s1_5cl <- cluster.stats(kmeans_s1_5cl_d, as.numeric(clusters5_s1_spread$cluster_kmeans_5))
diagnostics_LS_rebase_kmeans_s2_4cl <- cluster.stats(kmeans_s2_4cl_d, as.numeric(clusters4_s2_spread$cluster_kmeans_4))
diagnostics_LS_rebase_kmeans_s2_5cl <- cluster.stats(kmeans_s2_5cl_d, as.numeric(clusters5_s2_spread$cluster_kmeans_5))
diagnostics_LS_rebase_kmeans_sep_3cl <- cluster.stats(kmeans_s1_s2_3cl_d, as.numeric(clusters3_s1_s2_spread$cluster_kmeans_3))
diagnostics_LS_rebase_kmeans_sep_5cl <- cluster.stats(kmeans_s1_s2_5cl_d, as.numeric(clusters5_s1_s2_spread$cluster_kmeans_5))
diagnostics_LS_rebase_kmeans_cont_2cl <- cluster.stats(kmeans_cont_2cl_d, as.numeric(clusters2_cont_spread$cluster_kmeans_2))
diagnostics_LS_rebase_kmeans_cont_3cl <- cluster.stats(kmeans_cont_3cl_d, as.numeric(clusters3_cont_spread$cluster_kmeans_3))
diagnostics_LS_rebase_kmeans_cont_5cl <- cluster.stats(kmeans_cont_5cl_d, as.numeric(clusters5_cont_spread$cluster_kmeans_5))
...
```{r}
# write table
write.csv(diagnostic_df, "diagnostics_LS_rebase_kmeans.csv")
```