...
write.csv(df_with_dct, "CENT_dct_40p.csv")
write.csv(df_final, "CENT_dct_40p_spread.csv")
...
write.csv(dct_s1_s2, "CENT_dct_40p_s1_s2.csv")
...
write.csv(dct_cont, "CENT_dct_40p_cont.csv")
write.csv(dct_spread_cont, "CENT_dct_40p_spread_cont.csv")
