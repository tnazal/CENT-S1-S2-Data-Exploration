...
write.csv(dct_C3_raw_growth, "CENT_dct_C3_raw_growth.csv")
write.csv(dct_spread_C3_raw_growth, "CENT_dct_spread_C3_raw_growth.csv")
...
write.csv(dct_LS_raw_growth, "CENT_dct_LS_raw_growth.csv")
write.csv(dct_spread_LS_raw_growth, "CENT_dct_spread_LS_raw_growth.csv")
