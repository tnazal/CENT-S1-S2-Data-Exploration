...
```{r}
table(kshape_C3$k_5@cluster)
```

```{r}
plot(kshape_C3$k_5, type = 'sc')
```
...
```{r}
table(dtw_C3$k_5@cluster)
```

```{r}
plot(dtw_C3$k_5, type = 'sc')
```
...
```{r}
table(kshape_LS$k_5@cluster)
```

```{r}
plot(kshape_LS$k_5, type = 'sc')
```
...
```{r}
table(dtw_LS$k_3@cluster)
```

```{r}
plot(dtw_LS$k_3, type = 'sc')
```
