...
# diagnostics
diagnostics_kshape_C3_raw_s1_2cl <- cluster.stats(s1_2clusters_d, as.numeric(clusters_s1_shape2_spread$cluster_shape_2))
diagnostics_kshape_C3_raw_s2_4cl <- cluster.stats(s2_4clusters_d, as.numeric(clusters_s2_shape4_spread$cluster_shape_4))
diagnostics_kshape_C3_raw_cont_4cl <- cluster.stats(cont_4clusters_d, as.numeric(clusters_cont_shape4_spread$cluster_shape_4))
diagnostics_kshape_C3_raw_sep_4cl <- cluster.stats(s1_s2_4clusters_d, as.numeric(clusters_s1_s2_shape4_spread$cluster_shape_4))
diagnostics_dtw_C3_raw_s1_3cl <- cluster.stats(s1_3clusters_d, as.numeric(clusters_s1_dtw3_spread$cluster_dtw_3))
diagnostics_dtw_C3_raw_s2_2cl <- cluster.stats(s2_2clusters_d, as.numeric(clusters_s2_dtw2_spread$cluster_dtw_2))
diagnostics_dtw_C3_raw_cont_4cl <- cluster.stats(cont_4clustdtw_d, as.numeric(clusters_cont_dtw4_spread$cluster_dtw_4))
diagnostics_dtw_C3_raw_sep_5cl <- cluster.stats(s1_s2_5clusters_d, as.numeric(clusters_s1_s2_dtw5_spread$cluster_dtw_5))
...
```{r}
# write table
write.csv(diagnostic_df, "diagnostics_kshape_dtw_C3_raw.csv")
```