...
#         dct_C3_growth_cont.csv, dct_spread_C3_growth_cont.csv, 
#
...
tadpole_clust5_s1 <- tsclust(dtw_df_s1, type = "tadpole", k = 5L, 
                             control = tadpole_control(dc = 25, window.size = 25))
...
tadpole_clust4_s2 <- tsclust(dtw_df_s2, type = "tadpole", k = 4L, 
                             control = tadpole_control(dc = 20, window.size = 5))
...
# diagnostics
diagnostics_tadpole_C3_growth_s1_5cl <- cluster.stats(tadpole_s1_5cl_d, as.numeric(tadpole_clust5_s1_df$cluster))
diagnostics_tadpole_C3_growth_s1_3cl <- cluster.stats(tadpole_s1_3cl_d, as.numeric(tadpole_clust3_s1_df$cluster))
diagnostics_tadpole_C3_growth_s2_4cl <- cluster.stats(tadpole_s2_4cl_d, as.numeric(tadpole_clust4_s2_df$cluster))
diagnostics_tadpole_C3_growth_s2_3cl <- cluster.stats(tadpole_s2_3cl_d, as.numeric(tadpole_clust3_s2_df$cluster))
diagnostics_tadpole_C3_growth_cont_5cl <- cluster.stats(tadpole_cont_5cl_d, as.numeric(tadpole_clust5_cont_df$cluster))
diagnostics_tadpole_C3_growth_cont_3cl <- cluster.stats(tadpole_cont_3cl_d, as.numeric(tadpole_clust3_cont_df$cluster))
diagnostics_tadpole_C3_growth_sep_5cl <- cluster.stats(tadpole_sep_5cl_d, as.numeric(tadpole_clust5_s1_s2_df$cluster))
diagnostics_tadpole_C3_growth_sep_3cl <- cluster.stats(tadpole_sep_3cl_d, as.numeric(tadpole_clust3_s1_s2_df$cluster))
...
```{r}
# write table
write.csv(diagnostic_df, "diagnostics_tadpole_C3_growth.csv")
```