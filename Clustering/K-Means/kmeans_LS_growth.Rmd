...
write.csv(clusters5_s1, "kmeans_LS_growth_s1_5cl.csv")
```
...
write.csv(dct_s1_5clusters_s2_trends, "kmeans_LS_growth_s1_5cl_s2trends.csv")
```
...
write.csv(s1_clusters_cont_trends, "kmeans_LS_growth_s1_5cl_cont_trends.csv") 
```
...
# diagnostics
diagnostics_kmeans_LS_growth_s1_4cl <- cluster.stats(kmeans_s1_4cl_growth_d, as.numeric(clusters4_s1_spread$cluster_kmeans_4))
diagnostics_kmeans_LS_growth_s1_5cl <- cluster.stats(kmeans_s1_5cl_growth_d, as.numeric(clusters5_s1_spread$cluster_kmeans_5))
diagnostics_kmeans_LS_growth_s2_3cl <- cluster.stats(kmeans_s2_3cl_growth_d, as.numeric(clusters3_s2_spread$cluster_kmeans_3))
diagnostics_kmeans_LS_growth_s2_2cl <- cluster.stats(kmeans_s2_2cl_growth_d, as.numeric(clusters2_s2_spread$cluster_kmeans_2))
diagnostics_kmeans_LS_growth_s2_5cl <- cluster.stats(kmeans_s2_5cl_growth_d, as.numeric(clusters5_s2_spread$cluster_kmeans_5))
diagnostics_kmeans_LS_growth_sep_3cl <- cluster.stats(kmeans_s1_s2_3cl_growth_d, as.numeric(clusters3_s1_s2_spread$cluster_kmeans_3))
diagnostics_kmeans_LS_growth_sep_5cl <- cluster.stats(kmeans_s1_s2_5cl_growth_d, as.numeric(clusters5_s1_s2_spread$cluster_kmeans_5))
diagnostics_kmeans_LS_growth_cont_3cl <- cluster.stats(kmeans_cont_3cl_growth_d, as.numeric(clusters3_cont_spread$cluster_kmeans_3))
diagnostics_kmeans_LS_growth_cont_2cl <- cluster.stats(kmeans_cont_2cl_growth_d, as.numeric(clusters2_cont_spread$cluster_kmeans_2))
diagnostics_kmeans_LS_growth_cont_5cl <- cluster.stats(kmeans_cont_5cl_grwoth_d, as.numeric(clusters5_cont_spread$cluster_kmeans_5))
...
```{r}
# write table
write.csv(diagnostic_df, "diagnostics_kmeans_LS_growth.csv")
```
