...
#         dct_C3_raw_s1_S2.csv, dct_C3_raw_cont.csv, dct_spread_C3_raw_cont.csv  
#
...
Using the factoextra package, we run several different optimization visualizations to decide the best number of clusters to use.
...
#based on diagnostics, this was the best cluster for C3 raw season 1, so save data
write.csv(clusters5_s1, "kmeans_C3_raw_s1_5cl.csv")
```
...
#based on diagnostics, this was the best cluster for C3 raw season 1, so save data
write.csv(dct_s1_5clusters_s2_trends, "kmeans_C3_raw_s1_5cl_s2trends.csv")
```
...
#same plot as before, but legend is grouped by network for easier distinction
...
write.csv(s1_clusters_cont_trends, "kmeans_C3_raw_s1_5cl_cont_trends.csv") 
```
...
# diagnostics
diagnostics_kmeans_C3_raw_s1_3cl <- cluster.stats(kmeans_s1_3cl_d, as.numeric(clusters3_s1_spread$cluster_kmeans_3))
diagnostics_kmeans_C3_raw_s1_4cl <- cluster.stats(kmeans_s1_4cl_d, as.numeric(clusters4_s1_spread$cluster_kmeans_4))
diagnostics_kmeans_C3_raw_s1_5cl <- cluster.stats(kmeans_s1_5cl_d, as.numeric(clusters5_s1_spread$cluster_kmeans_5))
diagnostics_kmeans_C3_raw_s2_3cl <- cluster.stats(kmeans_s2_3cl_d, as.numeric(clusters3_s2_spread$cluster_kmeans_3))
diagnostics_kmeans_C3_raw_s2_4cl <- cluster.stats(kmeans_s2_4cl_d, as.numeric(clusters4_s2_spread$cluster_kmeans_4))
diagnostics_kmeans_C3_raw_s2_5cl <- cluster.stats(kmeans_s2_5cl_d, as.numeric(clusters5_s2_spread$cluster_kmeans_5))
diagnostics_kmeans_C3_raw_sep_3cl <- cluster.stats(kmeans_s1_s2_3cl_d, as.numeric(clusters3_s1_s2_spread$cluster_kmeans_3))
diagnostics_kmeans_C3_raw_sep_5cl <- cluster.stats(kmeans_s1_s2_5cl_d, as.numeric(clusters5_s1_s2_spread$cluster_kmeans_5))
diagnostics_kmeans_C3_raw_cont_3cl <- cluster.stats(kmeans_cont_3cl_d, as.numeric(clusters3_cont_spread$cluster_kmeans_3))
diagnostics_kmeans_C3_raw_cont_5cl <- cluster.stats(kmeans_cont_5cl_d, as.numeric(clusters5_cont_spread$cluster_kmeans_5))
...
```{r}
# write table
write.csv(diagnostic_df, "diagnostics_kmeans_C3_raw.csv")
```
