...
```{r}
##################################################################################
# inputs: dct_LS_raw.csv, dct_spread_LS_raw.csv,  
...
tadpole_clust5_s1 <- tsclust(dtw_df_s1, type = "tadpole", k = 5L, 
                             control = tadpole_control(dc = 2, window.size = 50))
...
tadpole_clust4_s2 <- tsclust(dtw_df_s2, type = "tadpole", k = 4L, 
                             control = tadpole_control(dc = 15, window.size = 5))
...
# diagnostics
diagnostics_tadpole_LS_raw_s1_5cl <- cluster.stats(tadpole_s1_5cl_d, as.numeric(tadpole_clust5_s1_df$cluster))
diagnostics_tadpole_LS_raw_s1_3cl <- cluster.stats(tadpole_s1_3cl_d, as.numeric(tadpole_clust3_s1_df$cluster))
diagnostics_tadpole_LS_raw_s2_4cl <- cluster.stats(tadpole_s2_4cl_d, as.numeric(tadpole_clust4_s2_df$cluster))
diagnostics_tadpole_LS_raw_s2_3cl <- cluster.stats(tadpole_s2_3cl_d, as.numeric(tadpole_clust3_s2_df$cluster))
diagnostics_tadpole_LS_raw_cont_5cl <- cluster.stats(tadpole_cont_5cl_d, as.numeric(tadpole_clust5_cont_df$cluster))
diagnostics_tadpole_LS_raw_cont_3cl <- cluster.stats(tadpole_cont_3cl_d, as.numeric(tadpole_clust3_cont_df$cluster))
diagnostics_tadpole_LS_raw_sep_5cl <- cluster.stats(tadpole_sep_5cl_d, as.numeric(tadpole_clust5_s1_s2_df$cluster))
diagnostics_tadpole_LS_raw_sep_3cl <- cluster.stats(tadpole_sep_3cl_d, as.numeric(tadpole_clust3_s1_s2_df$cluster))
...
```{r}
# write table
write.csv(diagnostic_df, "diagnostics_tadpole_LS_raw.csv")
```