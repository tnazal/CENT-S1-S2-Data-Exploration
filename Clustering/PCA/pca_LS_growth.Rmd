...
# diagnostics
diagnostics_pca_LS_growth_s1_3cl <- cluster.stats(pca_s1_3cl_d, as.numeric(df_pcaclusters_s1$cluster))
diagnostics_pca_LS_growth_s2_3cl <- cluster.stats(pca_s2_3cl_d, as.numeric(df_pcaclusters_s2$cluster))
diagnostics_pca_LS_growth_cont_3cl <- cluster.stats(pca_cont_3cl_d, as.numeric(df_pcaclusters_cont$cluster))
diagnostics_pca_LS_growth_sep_4cl <- cluster.stats(pca_sep_4cl_d, as.numeric(df_pcaclusters_s1_s2$cluster))
...
```{r}
# write table
write.csv(diagnostic_df, "diagnostics_pca_LS_growth.csv")
```
