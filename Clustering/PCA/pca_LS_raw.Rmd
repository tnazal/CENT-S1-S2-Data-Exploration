...
```{r}
##################################################################################
# inputs: dct_LS_raw.csv, dct_spread_LS_raw.csv, dct_spread_LS_raw_cont.csv 
#
...
# diagnostics
diagnostics_pca_LS_raw_s1_3cl <- cluster.stats(pca_s1_3cl_d, as.numeric(df_pcaclusters_s1$cluster))
diagnostics_pca_LS_raw_s2_3cl <- cluster.stats(pca_s2_3cl_d, as.numeric(df_pcaclusters_s2$cluster))
diagnostics_pca_LS_raw_cont_3cl <- cluster.stats(pca_cont_3cl_d, as.numeric(df_pcaclusters_cont$cluster))
diagnostics_pca_LS_raw_sep_4cl <- cluster.stats(pca_sep_4cl_d, as.numeric(df_pcaclusters_s1_s2$cluster))
...
```{r}
# write table
write.csv(diagnostic_df, "diagnostics_pca_LS_raw.csv")
```